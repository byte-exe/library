...
<table width="100%">
<tr>
<td style"with: 18mm"><img src="<?=base_URL()?>aset/<?=$i->logo?>" style="width: 50px; height: 50px"></td>
...
<tr><td style="text-align: center">Nama</td><td>:</td><td> <b><?=$d->nama?></b></td></tr>
<tr><td style="text-align: center">Alamat</td><td>:</td><td><b><?=substr($d->alamat, 0, 50)?></b></td></tr>
<tr><td style="text-align: center">J K</td><td>:</td><td><b><?=$d->jk?></b></td></tr>
<tr><td style="text-align: center">Agama</td><td>:</td><td><b><?=$d->agama?></b></td></tr>
<tr><td style="text-align: center">T T L</td><td>:</td><td><b><?=$d->tmp_lahir.", ".tgl_panjang($d->tgl_lahir, "sm")?></b></td></tr>
