...
<form action="<?=base_URL()?>apps/nama_perpus/<?=$act?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">	
	...
	<label style="width: 250px; float: left">Kepsek</label><input class="span6" type="text" name="kepsek" placeholder="Nama kepsek" value="<?=$kepsek?>" required><br>
	<label style="width: 250px; float: left">NIP kepsek</label><input class="span6" type="text" name="kepsek_nip" placeholder="NIP kepsek" value="<?=$kepsek_nip?>" required><br>
